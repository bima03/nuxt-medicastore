<template>
    ...
    <ul class="nav nav-fill nav-justify custom-tabs w-100">
      <li class="nav-item">
...
<script lang="ts" setup>
    ...
    import { PhCaretDown, PhDotOutline, PhHospital, PhMagnifyingGlass, PhMapPin, PhStethoscope } from '@phosphor-icons/vue';

    const route = useRoute()
    const searchParam = route.params.keyword
    
    const keyword = ref("")

    watchEffect(() => {
      keyword.value = searchParam
    })
